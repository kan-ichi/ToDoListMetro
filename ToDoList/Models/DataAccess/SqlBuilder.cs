...
namespace ToDoList.Models.DataAccess
{
    public class SqlBuilder
    {
        ...
        public SqlBuilder(MainViewSearchConditions _cond)
        {
            ...
            this.CommandText = @"SELECT * FROM todo_task WHERE status_code <> @status_code ORDER BY due_date";
        ...
        public SqlBuilder(EditViewSearchConditions _cond)
        {
            ...
            this.CommandText = @"SELECT * FROM todo_task" + whereClause + @" ORDER BY due_date";
